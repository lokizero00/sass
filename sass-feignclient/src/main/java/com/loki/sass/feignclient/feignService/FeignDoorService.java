...
public interface FeignDoorService {
    ...
    ResultDTO<PageInfo<DoorDTO>> getDoorListSearch(@RequestParam("doorQueryJson") String doorQueryJson) throws BizException;

    @RequestMapping(method = RequestMethod.POST,value = "/door/v1/addDoor")
    ResultDTO<Boolean> addDoor(@RequestParam("doorRequestStr") String doorRequestStr) throws BizException;

    @RequestMapping(method = RequestMethod.POST,value = "/door/v1/editDoor")
    ResultDTO<Boolean> editDoor(@RequestParam("doorRequestStr") String doorRequestStr) throws BizException;

    @RequestMapping(method = RequestMethod.POST,value = "/door/v1/deleteDoor")
    ResultDTO<Boolean> deleteDoor(@RequestParam("doorId") Integer doorId, @RequestParam("adminId") Integer adminId) throws BizException;
}
