package com.loki.sass.api.web.aop.aspect;
...
public class WebLogAspect {
	...
	@Pointcut("execution(public * com.loki.sass.service.web.controller..*.*(..)) && @annotation(com.loki.sass.api.web.aop.bind.Operate)")
	public void webLog(){}
